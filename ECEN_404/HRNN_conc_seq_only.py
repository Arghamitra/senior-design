...
parser.add_argument('--data_processed_dir', type=str, default='/home/argha/WORK/extracted_data/vector_machine_data/')
...
class net_crossInteraction(nn.Module):
    def __init__(self, lambda_l1, lambda_fused, lambda_group, lambda_bind):
        super().__init__()
        self.mod_aminoAcid_embedding = nn.Embedding(29, 128)
