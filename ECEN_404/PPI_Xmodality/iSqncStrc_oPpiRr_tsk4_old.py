...
def calculate_AUPRC(model,loader, batch_size):
    len_prot_data1 = []
    len_prot_data2 = []
    ...
    for prot_data1, prot_data2, label, INTER_prot_contact, INTRA_prot_contact1, INTRA_prot_contact2 in loader:
        ...
        with torch.no_grad():
            ...
            inter, _, Len_prot_data1, Len_prot_data2 = model.module.forward(prot_data1, prot_data2, INTRA_prot_contact1, INTRA_prot_contact2)
...
if args.train == 1:
    ...
    for epoch in range(args.epoch):
        ...
        for prot_data1, prot_data2, label, INTER_prot_contact, INTRA_prot_contact1, INTRA_prot_contact2 in train_loader:
            ...
            inter, affn, len_prot_data1, len_prot_data2 = model(prot_data1, prot_data2, INTRA_prot_contact1, INTRA_prot_contact2)
