...
def open_file(file_npy, sqnc_filename):
    ...
    multiple_matrix(sqnc_numA, file_num='test_sqnc_A', offset=1000)
    multiple_matrix(sqnc_numB, file_num='test_sqnc_B', offset = 1000)


def main():
    file_npy = np.load("Test_intrctn_list.npy")
